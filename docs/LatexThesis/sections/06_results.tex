...
recall, and F1-score for the \texttt{weapon} class; \textit{Conf.} indicates the mean maximum predicted-class probability and is
...
\vspace{0.4em}
\footnotesize
\textit{Note.} \textit{W-rate} indicates the proportion of \gls{ood}
