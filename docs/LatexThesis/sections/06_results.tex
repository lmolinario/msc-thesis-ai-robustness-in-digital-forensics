...
The adversarial variants were generated against fold-aware EfficientNet-B0
checkpoints rather than against the proprietary systems. Their use in this
section consequently represents a black-box transfer evaluation of the same
artifacts, not a white-box attack against the selected black-box software
systems.
...
Limited degradation with respect to the tested perturbations; adversarial
stability does not eliminate OOD risk. \\
...
\begin{figure}[H]
    ...
    \caption[Operational risk summary across evaluated systems]{Operational risk summary across proxy models and selected black-box software systems. The figure reports quantitative indicators relevant to forensic image triage: clean false negative rate, bundle false positive rate on the interpretable binary bundle, out-of-distribution weapon flag rate, adversarial false negative rate, anti-forensic false negative rate, adversarial accuracy drop, and anti-forensic accuracy drop. The values are derived from the normalized experimental metrics reported in Chapter~\ref{chap:results}. Interpretability differences between inspectable proxy models and black-box software systems are discussed separately and are not encoded as a numerical score in the figure}
...
Third, \gls{ood} behavior remains an autonomous risk: it may increase the
