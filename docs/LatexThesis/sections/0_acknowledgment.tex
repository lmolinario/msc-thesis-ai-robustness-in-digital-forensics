...
a chi mi ha aiutato ad essere ciò che sono,\\
alla mia famiglia di origine\\
ed alla mia famiglia acquisita.\\[0.5cm]

A Mario,\\
esempio di cambiamento.\\[0.5cm]

A Davide,\\
guida in un viaggio inaspettato.\\[0.5cm]

A Silvia,\\
preziosa compagna di viaggio.\\[0.5cm]
