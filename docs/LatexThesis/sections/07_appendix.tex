...
selected black-box software systems. The \codepath{explainability/} directory
is reserved for the generation of \gls{xai}-based case studies, whereas
\codepath{docs/LatexThesis/} contains the LaTeX version of the thesis.
