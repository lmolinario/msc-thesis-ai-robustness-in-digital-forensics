...
possible to observe whether images that are external to or ambiguous with
respect to the task are mapped with excessive confidence to the categories
defined by the classifier \cite{hendrycks2017baseline,fort2021exploring}.
