...
The results obtained on \gls{resnet18}, the \gls{clip}-based proxy, and the selected
black-box software configurations measure only empirical transfer of the
\gls{efficientnetb0}-oriented artifacts. They do not establish robustness against
attacks optimized independently for those systems.

\item \textbf{Proxy-model role.}

\gls{efficientnetb0}, \gls{resnet18}, and the \gls{clip}-based model are transparent
...
\gls{efficientnetb0} cases. The set is not statistically representative and cannot
...
model-dependent attacks were generated only against \gls{efficientnetb0}. Generating
comparable attacks independently against \gls{resnet18} and the
