...
\newglossaryentry{excirefoto2025}{
    ...
    description={standalone general-purpose image management software with AI-based semantic search capabilities, evaluated in this thesis as a black-box image retrieval and classification tool}
}
