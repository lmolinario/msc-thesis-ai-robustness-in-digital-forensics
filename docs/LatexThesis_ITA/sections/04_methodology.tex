...
training e nel registro \texttt{models/model\_registry.json}, così da mantenere
...
\cite{moosavi2016deepfool,zajac2020superdeepfool}. Color Shift, infine, non è
...
Lo script ufficiale per questa fase è
\texttt{datasets/scripts/bundle/16\_build\_forensic\_evaluation\_bundle.py}.
...
directory principale \texttt{datasets/forensic\_evaluation\_bundle/} contiene
...
all'interno di \texttt{datasets/forensic\_evaluation\_bundle/}. Non devono
...
\texttt{datasets/forensic\_evaluation\_bundle/metadata/bundle\_manifest.csv}.
...
\texttt{evaluation/scripts/15\_evaluate\_proxy\_models.py}. Lo script considera
...
\texttt{evaluation/proxy\_models/proxy\_model\_predictions.csv} e i file metrici
in \texttt{results/metrics/}: \texttt{proxy\_model\_clean\_metrics.csv},
...
\texttt{explainability/scripts/17\_generate\_integrated\_gradients\_case\_studies.py}.
...
\texttt{evaluation/proxy\_models/proxy\_model\_predictions.csv}. A partire da
...
\texttt{explainability/outputs/integrated\_gradients/} e documentati mediante
tre manifest: \texttt{explainability/manifests/integrated\_gradients\_manifest.csv},
\texttt{explainability/manifests/xai\_case\_studies\_manifest.csv} e
\texttt{explainability/manifests/integrated\_gradients\_summary.json}. Il primo
...
il file \texttt{models/model\_registry.json} registra il checkpoint, la
