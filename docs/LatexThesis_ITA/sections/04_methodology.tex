...
\codepath{proxy/model/clean/metrics.csv},

\codepath{proxy/model/adversarial/metrics.csv},

\codepath{proxy/model/anti/forensic/metrics.csv},

\codepath{proxy/model/ood/metrics.csv},

\codepath{proxy/model/comparative/metrics.csv} e

\codepath{proxy/model/evaluation/summary.json}.
...
\texttt{metadata.csv} a \codepath{review/manifest/full.csv}, poi a
\codepath{manual/selection/final/1500.csv},
\codepath{manual/selection/adversarial/subset.csv},
\codepath{clean/folds/manifest.csv}, \codepath{ood/eval/manifest.csv},
manifest degli attacchi, manifest anti-forense, \codepath{bundle/manifest.csv},
