...
\codepath{bundle_manifest.csv} mediante \texttt{bundle_id}, nome del file cieco
...
\codepath{original_image_id}, \codepath{generated_image_id},
\codepath{bundle_id}, hash e path rappresenta il collegamento minimo necessario
