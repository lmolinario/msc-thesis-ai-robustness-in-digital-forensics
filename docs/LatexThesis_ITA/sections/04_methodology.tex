...
\texttt{structured\_audit\_view/clean/}
&
Vista interna degli artefatti puliti del subset binario. \\
\texttt{structured\_audit\_view/ood/}
&
Vista interna del set \gls{ood}. \\
\texttt{structured\_audit\_view/adversarial/}
&
Vista interna delle immagini generate mediante attacchi adversariali. \\
\texttt{structured\_audit\_view/anti\_forensic/}
&
...
\texttt{datasets/forensic\_evaluation\_bundle/blind\_tool\_input/files/}.
Non devono invece essere importate le directory \texttt{metadata/} e
...
al set \gls{ood} e 30\,000 righe relative a campioni perturbati. In termini di
famiglia di attacco, il summary distingue 10\,500 righe con
\texttt{attack\_family = none}, 15\,000 righe adversariali e 15\,000 righe
anti-forensi. Questi valori descrivono la copertura della valutazione
metodologica e non devono essere interpretati come risultati di performance.
...
bundle, valutazione metrica ed explainability. In coerenza con i principi della
