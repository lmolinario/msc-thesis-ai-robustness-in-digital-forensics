...
\texttt{D50} rappresenta il setting principale della valutazione, poiché bilancia
richiamo della classe \texttt{weapon} e controllo del rumore operativo. La
...
\texttt{D50} mantiene un compromesso più equilibrato tra richiamo e
selettività nel contesto sperimentale considerato.
