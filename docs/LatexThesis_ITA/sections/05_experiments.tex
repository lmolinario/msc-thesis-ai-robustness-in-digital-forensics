...
\gls{excirefoto2025} in configurazione \texttt{D50} e 29.20\% per
\gls{cellebriteinseyets}. Tali valori non rappresentano errori binari in senso
...
architettura, training set, soglie decisionali, preprocessing interno o logica
completa di classificazione. La comparazione tra
\gls{magnetaxiomtool}/\gls{magnetai}, \gls{excirefoto2025} e
\gls{cellebriteinseyets} deve quindi essere interpretata come confronto operativo
