...
&
\textbf{Normalizzato / consolidato}
&
Bundle processato ed export normalizzato rispetto alla ground truth
sperimentale. Il tag \texttt{Possible weapons} è stato ricondotto
operativamente alla predizione positiva per la classe \texttt{weapon}. \\

X-Ways Forensics / Excire Photo AI
&
\textbf{Normalizzato / consolidato}
&
Excire Photo AI è stato valutato come classificatore black-box basato su
semantic retrieval, non come classificatore nativo
\texttt{weapon}/\texttt{non\_weapon}. Sono state considerate tre configurazioni
operative del parametro \texttt{Distance limit}: \texttt{D20}, \texttt{D50} e
\texttt{D80}. \\

Cellebrite UFED
&
\textbf{Non incluso nella comparazione quantitativa}
&
Lo strumento rimane rilevante nella pipeline operativo-forense, ma non è incluso
nella comparazione quantitativa finale in assenza di export normalizzati,
riproducibili e direttamente associabili al forensic evaluation bundle. La sua
rilevanza è pertanto discussa sul piano metodologico e procedurale. \\

Oxygen Forensic Detective
&
\textbf{Non incluso nella comparazione quantitativa}
&
Lo strumento rimane rilevante nella pipeline operativo-forense, ma la sua
inclusione quantitativa richiederebbe output strutturati, normalizzabili e
riconducibili in modo univoco alla ground truth sperimentale. \\
...
Consolidato
&
Il forensic evaluation bundle è stato processato e l'export è stato normalizzato
rispetto alla ground truth sperimentale. Il tag \texttt{Possible weapons} è
utilizzato come segnale operativo positivo per la classe \texttt{weapon}. \\

X-Ways Forensics / Excire Photo AI -- \texttt{D20}
&
Consolidato
&
Configurazione restrittiva di semantic retrieval. Riduce i falsi positivi e il
weapon flag rate sugli \gls{ood}, ma aumenta il rischio di falsi negativi sulla
classe \texttt{weapon}. \\

X-Ways Forensics / Excire Photo AI -- \texttt{D50}
&
Consolidato
&
Configurazione intermedia, utilizzata come setting principale per il confronto
operativo. Presenta, nel contesto sperimentale considerato, un profilo
equilibrato tra alto richiamo sulla classe \texttt{weapon} e controllo ancora
gestibile dei falsi positivi. \\

X-Ways Forensics / Excire Photo AI -- \texttt{D80}
&
Consolidato
&
Configurazione permissiva. Massimizza il recall sulla classe \texttt{weapon}, ma
aumenta sensibilmente il \gls{fpr} e il weapon flag rate sugli input
\gls{ood}. \\

Cellebrite UFED
&
Non incluso nella comparazione quantitativa finale
&
Lo strumento rimane rilevante nel workflow forense, ma non sono disponibili
output normalizzati e comparabili per la classificazione automatizzata di
immagini rispetto al forensic evaluation bundle. \\

Oxygen Forensic Detective
&
Non incluso nella comparazione quantitativa finale
&
La valutazione quantitativa richiede moduli automatici, export strutturati e
mapping verificabile rispetto alla ground truth sperimentale. \\
