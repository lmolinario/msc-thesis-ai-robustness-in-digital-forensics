...
riproducibili. I tool commerciali, invece, espongono categorie proprietarie,
risultati di semantic retrieval o output di media analysis che devono essere
...
0.032 &
0.292 &
Buon equilibrio nel clean set, con OOD weapon flag rate più
contenuto rispetto agli altri tool black-box valutati. \\
...
con un \gls{fpr} superiore rispetto a Griffeye. \gls{magnetai} risulta più
...
generazione dei bookmark. La comparazione tra
\gls{magnetaxiomtool}/\gls{magnetai}, \gls{excirefoto2025},
\gls{cellebriteinseyets} e \gls{griffeye}/\gls{t3kcore} deve quindi essere interpretata come confronto operativo
di triage, non come confronto tra classificatori omogenei e pienamente
...
I risultati mostrano che la robustezza operativa degli strumenti
\gls{ai}-based in ambito forense non può essere ridotta alla sola accuracy clean
né alla presenza di un singolo attacco critico. I tool commerciali black-box
mostrano profili differenziati: \gls{griffeye}/\gls{t3kcore} riduce in modo
marcato i falsi positivi e ottiene la migliore accuracy aggregata,
\gls{cellebriteinseyets} mantiene un recall elevato sulla classe
\texttt{weapon}, \gls{excirefoto2025} dipende sensibilmente dalla soglia di
retrieval e \gls{magnetai} presenta un profilo più conservativo ma più esposto a
falsi negativi in alcune condizioni. Questa eterogeneità conferma la necessità
di validazione sperimentale, normalizzazione esplicita degli output e revisione
human-in-the-loop.