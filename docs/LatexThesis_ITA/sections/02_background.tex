...
Un ulteriore attacco frequentemente impiegato nella valutazione della robustezza adversarial è \gls{pgd}, che estende l'idea degli attacchi gradient-based mediante aggiornamenti iterativi vincolati entro un intorno perturbativo. Nella presente tesi, tuttavia, \gls{pgd} non viene incluso nel protocollo sperimentale principale. La scelta deriva dalla volontà di mantenere il workflow computazionalmente sostenibile e focalizzato sulla robustezza operativa in ambito forense, utilizzando \textit{SuperDeepFool} e \textit{Sigma Zero} come rappresentanti di famiglie di perturbazione iterativa e sparse, coerenti con le esigenze operative della pipeline.
